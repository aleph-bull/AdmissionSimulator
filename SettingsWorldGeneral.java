...
public class SettingsWorldGeneral extends SettingsWorld
{
     ...
     * 
     */
    private static SettingsWorld.StatChooseImage student1 = null;
    private static SettingsWorld.StatChooseImage student2 = null;
    private static SettingsWorld.StatChooseImage university = null;
    ...
    public static String getStudent1Image() {
        if (student1 == null || student1.getChoosenImage() == null) {
            return "./images/bob_run1.png"; // Default image if not set yet
        }
        return student1.getChoosenImage();
    }
    
    public static String getStudent2Image() {
        if (student2 == null || student2.getChoosenImage() == null) {
            return "./images/bob_run1.png"; // Default image if not set yet
        }
    ...
    public static String getUniversityImage() {
        if (university == null || university.getChoosenImage() == null) {
            return "./images/universityofcatmeme.png"; // Default image if not set yet
        }
